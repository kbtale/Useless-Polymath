...
export const BitwisePractice: React.FC = () => {
  ...
  const [question, setQuestion] = useState<{ a: number; b: number; op: BitwiseOperation } | null>(
    null,
  );
      ...
      <div className={styles.practiceContainer}>
        ...
        {question && (
          <div className={styles.toolLayout} style={{ width: '100%' }}>
            ...
            <div className={styles.operatorDisplay}>{question.op}</div>
            ...
            <div className={styles.resultWrapper}>
              <div className={styles.sectionTitle}>
                {t('result_click')} ({userResult})
              </div>
              <CoreBitRow value={userResult} onChange={setUserResult} bits={8} interactive={true} />
            </div>
          </div>
        )}
